...
int a, b;
	...
	{
		cout << "WS ";
		for (b = 0; b < MONTHS_DATA+1; b++) //gets a +1 for the condition because there are actually 13 columns for the monthly data. the first column merely numbers the rows (or weather stations)
		{
				if (b == 0)
				{
					double milimeter;
